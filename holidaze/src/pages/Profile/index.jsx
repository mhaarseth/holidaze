...
export default function Profile() {
  ...
  if (isError) {
    ...
    return (
      <div className={styles.loginLink}><Link to="/login">Log in</Link> to view your profile</div>
    )
  }
                      ...
                      <div className={styles.cardBottomContainer}>
                        <div className={styles.cardTextContainer}>
                          ...
                          <p>
                            ...
                            venue.location.country.length > 12
                              ? `, ${venue.location.country.slice(0, 13)}..`
                              : ""}
                            {venue.location.country !== null &&
                            venue.location.country &&
                            venue.location.country.length < 13
                              ? `, ${venue.location.country}`
                              : ""}
                          </p>
                        </div>
